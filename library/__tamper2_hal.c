...
/**  
@file  __tamper2_hal.c
@brief   TAMPER2 HAL Interface
*/
/**
@defgroup   TAMPER2_HAL
@brief      Tamper2 HAL Interface
@{
...
/** @defgroup TAMPER2_HAL_COMPILE HAL Cofiguration */            /** @{ */
...
/** @defgroup TAMPER2_HAL_SPI HAL SPI Interface */               /** @{ */
...
/** @defgroup TAMPER2_HAL_I2C HAL I2C Interface */               /** @{ */
...
/** @defgroup TAMPER2_HAL_UART HAL UART Interface */             /** @{ */
...
/** @defgroup TAMPER2_HAL_GPIO HAL GPIO Interface */             /** @{ */
